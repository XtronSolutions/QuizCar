...
{
    public class CarAudio_Custom : MonoBehaviour
    {
        ...
        private vehicleHandling m_CarController; // Reference to car we are controlling
		...
		private void StartSound(){
            ...
            m_CarController = GetComponent<vehicleHandling>();
        ...
        private void Update(){
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarController._VehicleSpeed);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(m_CarController._AccelerationInput);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarController._VehicleSpeed);
