...
public class RCC_MobileButtons : MonoBehaviour {
	...
	private RCC_AutoInput InputValues;
	...
	void Start(){
		...
		InputValues = this.gameObject.GetComponent<RCC_AutoInput> ();
	}
...
//				RCC_SceneManager.Instance.activePlayerVehicle.gasInput = InputValues._AccelerationInput;
//				//RCC_SceneManager.Instance.activePlayerVehicle.brakeInput = InputValues._AccelerationInput;
//				RCC_SceneManager.Instance.activePlayerVehicle.steerInput = InputValues._SteeringInput;
//				RCC_SceneManager.Instance.activePlayerVehicle.boostInput = NOSInput;
